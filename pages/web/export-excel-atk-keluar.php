...
$tg1 = (isset($_REQUEST['tgl1']) && !empty($_REQUEST['tgl1']))?$_REQUEST['tgl1']:"";
	...
	$result=mysql_query("SELECT atk_".$fil.".tgl, atk_".$fil.".kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_keluar.divisi_penerima, atk_".$fil.".jumlah, atk_keluar.satuan
