...
<?php 
	...
	$reload="viewbarangkeluar.php?";
	//Cari berapa banyak jumlah data*/
	
	$count_query   = mysql_query("SELECT COUNT(data_atk.kode_atk) AS numrows,data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_masuk.satuan, data_atk.stok_tersedia FROM data_atk LEFT JOIN atk_masuk ON data_atk.kode_atk = atk_masuk.kode_atk");
	...
	$query = mysql_query("SELECT data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_masuk.satuan, data_atk.stok_tersedia
