...
while($rows = mysql_fetch_array($result)){
			?>
                  ...
                  <div align="center"><a href="?cat=gudang&page=barangedit&id=<?php echo sha1($rows['kode_atk']); ?>">EDIT</a> | <a href="delete.php?kode_atk=<?php echo $rows['kode_atk']; ?>">DELETE</a></div></td>
                </tr>
  <?php             
}if ($rows==0) { ?>
