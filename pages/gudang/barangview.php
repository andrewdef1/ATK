...
<tr align="center" >
    ...
    <td><a href="?cat=gudang&page=barangedit&id=<?php echo sha1($result['kode_atk']); ?>">Edit</a> - <a href="?cat=gudang&page=barang&del=1&id=<?php echo sha1($result['kode_atk']); ?>">Hapus</a></td>   
  </tr>
<?php
}
?>
