...
<?php 
	...
	$reload="?cat=gudang&page=entry";
	//Cari berapa banyak jumlah data*/
	
	$count_query   = mysql_query("SELECT COUNT(data_atk.kode_atk) AS numrows,atk_masuk.tgl, data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_masuk.jumlah, atk_masuk.satuan
FROM data_atk LEFT JOIN atk_masuk ON data_atk.kode_atk = atk_masuk.kode_atk");
	...
	$query = mysql_query("SELECT data_atk.kode_atk, atk_masuk.tgl, data_atk.nama_atk, data_atk.jenis_atk, atk_masuk.jumlah, atk_masuk.satuan
FROM data_atk LEFT JOIN atk_masuk ON data_atk.kode_atk = atk_masuk.kode_atk GROUP BY data_atk.kode_atk LIMIT $offset,$per_hal");
...
<thead>
  ...
  <tr>
    <td width="22%" class="no_sort"></td>
    <td width="12%" class="no_sort"></td>
  </tr>
  <tr align="center">
    <td>Tanggal</td>
    <td>Kode ATK</td>
    <td width="24%">Nama ATK</td>
    <td width="19%">Jenis ATK Masuk</td> 
