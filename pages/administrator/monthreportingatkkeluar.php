...
<select name="lp" id="lp" class="laptext">
      <option value="keluar">ATK Keluar</option>
    </select>
</form>
<?php
...
<?php 
	...
	$reload="dashboard.php?cat=administrator&page=monthreportingatkkeluar";
...
FROM atk_".$_POST['lp']." LEFT JOIN data_atk ON atk_".$_POST['lp'].".kode_atk = data_atk.kode_atk  Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY ID_".$_POST['lp']."");
	...
	$query=mysql_query("SELECT atk_".$_POST['lp'].".tgl, atk_".$_POST['lp'].".kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_keluar.divisi_penerima, atk_".$_POST['lp'].".jumlah, atk_keluar.satuan
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="11%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="17%">Export To <img src="img/excel.ico" border="1" width="32" height="32" onClick="window.open('<?php echo $baseurl."pages/web/export-excel-atk-keluar.php?tgl1=".$_POST['tglr']."&tgl2=".$_POST['tglr2']."&field=".$_POST['lp']; ?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" /></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="responsive table table-striped table-bordered">
  ...
  <tr align="center">
    ...
    <td class="no_sort">Divisi Penerima</td>
...
<tr align="center" >
    ...
    <td><?php echo $result['nama_atk']; ?></td>	    <td><?php echo $result['divisi_penerima']; ?></td>
