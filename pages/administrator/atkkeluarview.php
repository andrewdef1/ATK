...
<?php 
	...
	$reload="?cat=administrator&page=sell";
	//Cari berapa banyak jumlah data*/
	
	$count_query   = mysql_query("SELECT COUNT(data_atk.kode_atk) AS numrows,data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_keluar.divisi_penerima, atk_keluar.jumlah, atk_keluar.satuan
FROM data_atk LEFT JOIN atk_keluar ON data_atk.kode_atk = atk_keluar.kode_atk");
	...
	$query = mysql_query("SELECT data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, atk_keluar.divisi_penerima, atk_keluar.jumlah, atk_keluar.satuan
