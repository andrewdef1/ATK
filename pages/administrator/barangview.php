...
<?php 
	...
	$reload="?cat=administrator&page=barang";
	//Cari berapa banyak jumlah data*/
	
	$count_query   = mysql_query("SELECT COUNT(data_atk.kode_atk) AS numrows,data_atk.kode_atk, data_atk.nama_atk, data_atk.jenis_atk, data_atk.stok_tersedia FROM data_atk");
...
<tr align="center" >
    ...
    <td><a href="?cat=administrator&page=barangedit&id=<?php echo sha1($result['kode_atk']); ?>">Edit</a> - <a href="?cat=administrator&page=barang&del=1&id=<?php echo sha1($result['kode_atk']); ?>">Hapus</a></td>   
  </tr>
<?php
}
?>
